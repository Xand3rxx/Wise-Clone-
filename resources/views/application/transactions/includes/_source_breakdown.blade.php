<div class="mb-10" id="source-breakdown">
    <div class="row mb-5">
        <div class="col">
            ...
            <input type="text" class="form-control form-control-solid fs-1 @error('source_amount') is-invalid @enderror" placeholder="1,000" min="1" data-symbol="{{ $sourceCurrency['symbol'] }}" name="source_amount" data-max="{{ $sourceCurrencyBalance }}" max="{{ $sourceCurrencyBalance }}" id="source-amount" value="{{ old('source_amount') }}" autocomplete="off">
            @error('source_amount')
