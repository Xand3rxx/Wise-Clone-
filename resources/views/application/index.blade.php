...
<div class="toolbar py-5 py-lg-5" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl py-5">
        @if($user['latestCurrencyBalance']['USD']  == 1000)
        <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
            ...
            <div class="d-flex flex-stack flex-grow-1">
                <!--begin::Content-->
                <div class="fw-bold">
                    <div class="fs-6 text-gray-700"><strong>Congrats!</strong> {{ !empty($user['name']) ? Str::title($user['name']) : 'Unavailable' }} you have a gift of ${{ !empty($user['latestCurrencyBalance']['USD']) ? $user['latestCurrencyBalance']['USD'] : 0 }}. Click the <strong>New Transaction</strong> button to make a transaction.</div>
                </div>
                <!--end::Content-->
            </div>
            <!--end::Wrapper-->
